    ...
    <div class="col-xl-12">
        <div class="container">
            <div class="card-deck">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title mb-4"><center><strong>Profile</strong></center></h3>
                        <p class="card-text mb-1"><small class="text-muted">Username</small></p>
                        <p class="card-text">{{ $myDetails->name }}</p>
                        <p class="card-text mb-1"><small class="text-muted">Email</small></p>
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title mb-4"><center><strong>Thread</strong></center></h3>                        
                ...
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title mb-4"><center><strong>Reply</strong></center></h3>
