    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><strong>Delete</strong> Thread Confirmation!</h5>
            ...
            <div class="modal-footer">
                <a href="{{ route('delete_thread', $questions->id) }}" class="btn btn-danger">Delete</a>
...
<div class="modal fade" tabindex="-1" role="dialog" id="deleteReplyModal{{ $answer->id }}">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><strong>Delete</strong> Reply Confirmation!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer">
                <a href="{{ route('delete_reply', ['answer_id'=>$answer->id, 'id'=>$questions->id]) }}" class="btn btn-danger">Delete</a>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
